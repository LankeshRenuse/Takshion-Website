      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 lg:gap-10 items-center">
        ...
        >
          <motion.h3
            ...
            className="text-xl md:text-2xl lg:text-3xl mb-4 font-semibold text-center md:text-left"
            style={{ color: accentColor }}
          >
            <span className="text-white font-['Orbitron'] tracking-wider">
              Our{" "}
            </span>
            <span
          ...
          >
            ...
            <span style={{ color: accentColor }}>
              AI, robotics, automation, intelligent systems, and drone
              technology
            </span>{" "}
          ...
          <ul className="space-y-3 md:space-y-4 text-gray-300 text-sm md:text-base lg:text-lg">
            ...
            >
              <span className="mt-1 text-3xl" style={{ color: accentColor }}>
                ▸
              </span>
              <span>
                AI-driven systems for intelligent decision-making and automation
              </span>
            </motion.li>
            ...
            >
              ...
              <span>
                Continuous innovation through research, collaboration and
        ...
        >
          ...
          >
            At <b className="text-white font-[rajdhani]">Takshion</b>, we are a
            next-generation technology company building advanced solutions
            across <b className="text-white">AI, ML, Computer Vision</b> and
          ...
          >
            We specialize in{" "}
            <span style={{ color: accentColor }}>
              IoT, LLM integration, Robotics, Drones, UAVs, UGVs, and Autonomous
              Systems
            </span>
            , enabling real-world intelligent operations across land, air, sea,
            and space.
          </motion.p>

          <motion.p
            variants={lineVariants}
            className="text-gray-300 leading-relaxed text-sm md:text-base lg:text-lg max-w-xl mx-auto md:mx-0 font-[rajdhani]"
          >
            Our vision is to build{" "}
            <span style={{ color: accentColor }}>
              scalable, secure and intelligent technology ecosystems
            </span>{" "}
            that transform industries and deliver measurable impact.
          </motion.p>
        </motion.div>
      </div>
    </section>
