...
export default function Story() {
  ...
  className="w-full max-w-full md:max-w-full h-auto object-contain rounded-2xl"
        ...
        <div className="w-full md:w-1/2">
          ...
          <motion.div 
            className="bg-black/1 backdrop-blur-lg border border-[#22c55e]/10 rounded-2xl p-8 shadow-xl glow-target"
          ...
          >
            ...
            <motion.ul className="space-y-4 text-gray-300">
              ...
              <motion.li variants={lineVariants} className="flex gap-3 items-start">
                <span className="text-[#22c55e] text-3xl mt-1">▸</span>
                <span>
                  Takshion was founded 16 years ago to bridge technology and real-world challenges.
                </span>
              </motion.li>
