...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[100svh] lg:min-h-screen overflow-hidden flex items-start lg:items-center justify-center bg-black touch-pan-y"
...
/>
      ...
      <div className="relative z-[5] flex w-full flex-col items-center px-4 pt-[88px] pb-6 lg:hidden">
        <span
          className="block text-center uppercase text-sm font-semibold tracking-[2px]"
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="relative mt-4 flex w-full max-w-[340px] flex-col items-center justify-center"
          >
            <div className="absolute -inset-1 bg-[rgba(92,252,0,0.67)]/25 blur-[45px] rounded-full" />

            <div className="relative w-full overflow-hidden rounded-[20px] border border-white/10 backdrop-blur-xl bg-white/5 shadow-[0_20px_80px_rgba(0,0,0,0.6)]">
              <img
                src={slide.image}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h1 className="leading-tight text-center">
              <span className="block text-2xl font-bold text-white/90">
                {slide.title.split(" ").slice(0, -1).join(" ")}
              </span>
              <span className="block mt-1.5 text-2xl font-bold text-[rgba(92,252,0,0.67)]">
                {slide.title.split(" ").slice(-1)}
              </span>
            </h1>

            <p className="mx-auto mt-4 max-w-[320px] text-center text-[13px] leading-6 text-white/70 [text-wrap:pretty]">
              {slide.subtitle}
            </p>
          </motion.div>
        </AnimatePresence>
        ...
        <div className="mt-4 grid w-full max-w-[340px] grid-cols-2 gap-3">
          {slide.stats.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-start gap-1.5 rounded-xl border border-[rgba(92,252,0,0.67)]/15 bg-white/[0.03] p-2 transition-all duration-300 hover:border-[rgba(92,252,0,0.67)]/35 hover:bg-[rgba(92,252,0,0.67)]/5"
              >
                <Icon
                  size={22}
                  strokeWidth={1.8}
        ...
        <div className="mt-4 flex w-full max-w-[340px] flex-col items-stretch gap-3">
          <button
            onClick={() => scrollToSection("services")}
            className="w-full px-8 py-3 rounded-2xl bg-[rgba(92,252,0,0.67)] text-black font-semibold transition-all duration-300 hover:bg-[rgba(92,252,0,0.67)] hover:shadow-[0_0_20px_rgba(112,185,24,0.8),0_0_50px_rgba(112,185,24,0.5)]"
          >
            Explore Services
          </button>
          ...
          <button
            ...
            className="w-full px-8 py-3 rounded-2xl border border-[rgba(92,252,0,0.67)]/30 bg-[rgba(92,252,0,0.67)]/5 text-white backdrop-blur-md transition-all duration-300 hover:border-[#95E60E] hover:bg-[rgba(92,252,0,0.67)]/10 hover:shadow-[0_0_25px_rgba(112,185,24,0.7),0_0_60px_rgba(112,185,24,0.4)] hover:-translate-y-1"
          >
            Contact Us
          </button>
        </div>
      ...
      <div className="relative z-[5] hidden w-full max-w-[1370px] xl:max-w-[1480px] 2xl:max-w-[1600px] mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-10 sm:py-12 md:py-14 lg:py-4 lg:translate-x-1 xl:translate-x-4 2xl:translate-x-6 lg:grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-7 sm:gap-8 md:gap-10 lg:gap-4 xl:gap-6 2xl:gap-8 items-center lg:text-left">
        {/* LEFT CONTENT COLUMN */}
    ...
    TAKSHION DEEPTECH PVT. LTD.
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Subtitle */}
              <p className="mt-5 sm:mt-6 text-sm sm:text-base md:text-lg text-white/70 max-w-2xl leading-relaxed text-center sm:text-left text-balance">
                {slide.subtitle}
              </p>
              {current === 0 && (
