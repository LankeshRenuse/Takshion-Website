    ...
    return (
      <section id="product" className="relative py-20   px-2  text-white overflow-hidden scroll-mt-[-70px]">
        <div className="max-w-7xl mx-auto px-4 mb-8 text-center">
         ...
         <p className="mx-auto mt-5 max-w-3xl text-sm md:text-base leading-7 tracking-[0.01em] text-white/62 text-left md:text-center">
      ...
      <div className="relative w-full max-w-[1420px] mx-auto flex items-center px-4 xl:px-16">
          <button
            type="button"
            onClick={() => scroll("left")}
            aria-label="Scroll products left"
            className="absolute left-2 xl:left-0 z-30 grid h-11 w-11 place-items-center rounded-full border border-[rgba(92,252,0,0.67)]/40 bg-black/75 text-[rgba(92,252,0,0.67)] transition-all duration-300 hover:bg-[rgba(92,252,0,0.67)] hover:text-black hover:shadow-[0_0_28px_rgba(92,252,0,0.32)]"
          >
            <ArrowLeft size={20} />
          </button>
      ...
      onMouseLeave={stopDrag}
            ...
            className="flex w-full gap-4 overflow-x-auto pt-4 py-2 cursor-grab select-none [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
            variants={{
          ...
          <button
            ...
            className="absolute right-2 xl:right-0 z-30 grid h-11 w-11 place-items-center rounded-full border border-[rgba(92,252,0,0.67)]/40 bg-black/75 text-[rgba(92,252,0,0.67)] transition-all duration-300 hover:bg-[rgba(92,252,0,0.67)] hover:text-black hover:shadow-[0_0_80px_rgba(92,252,0,0.4)]"
          >
            <ArrowRight size={20} />
          </button>
        </div>
          ...
          {selectedProduct && (
            ...
            >
              ...
              <div className="relative flex flex-col p-5 sm:p-8 md:p-10 h-full overflow-y-auto">
                 ...
                 <p className="mt-3 text-sm leading-7 tracking-[0.01em] text-white/72 sm:mt-5 sm:text-base sm:leading-8 text-left lg:text-justify">
