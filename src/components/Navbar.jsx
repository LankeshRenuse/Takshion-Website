...
window.history.replaceState({}, "", `/#${id}`);
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex justify-between items-center px-5 xl:px-7 py-1 xl:py-2 max-w-8xl mx-auto">
 ...
 <div className="flex items-center gap-2">
  ...
  <img
    ...
    decoding="async"
    fetchPriority="high"
    className="h-[3.25rem] xl:h-16 w-auto object-contain scale-[1.18] xl:scale-[1.33] -translate-y-0.5 xl:-translate-y-1.5"
  />
</a>
      ...
      <AnimatePresence>
        {open && (
          <>
            ...
            >
              <div className="flex h-14 items-center justify-end border-b border-[rgba(92,252,0,0.67)]/10 w-full px-4">
                <button
                  type="button"
                  onClick={() => setOpen(false)}
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-[rgba(92,252,0,0.67)]/30 bg-[rgba(92,252,0,0.67)]/5 text-[rgba(92,252,0,0.67)]"
