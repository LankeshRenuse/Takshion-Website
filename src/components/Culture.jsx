    ...
    <section id="culture" className="py-12 px-4 relative scroll-mt-[-40px]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-10 lg:gap-10">
        ...
        <div className="w-full md:w-1/2">
          ...
          >
            <div
              className="h-full overflow-y-auto pl-2 pr-2 py-2 md:p-8  " 
            style={{
  scrollbarWidth: "thin",
...
>
              ...
              <motion.p
                variants={lineVariants}
              className="text-gray-300 mb-5 md:mb-6 leading-7 md:leading-relaxed text-sm md:text-base lg:text-lg tracking-[0.01em] text-left md:text-justify"
              >
              ...
              <motion.p
                variants={lineVariants}
               className="text-gray-400 mt-5 md:mt-6 text-xs md:text-sm leading-6 md:leading-relaxed tracking-[0.01em] text-left md:text-justify"
              >
