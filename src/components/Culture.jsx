...
>
              ...
              <motion.p
                variants={lineVariants}
              className="text-gray-300 mb-5 md:mb-6 leading-7 md:leading-relaxed text-sm md:text-base lg:text-lg tracking-[0.01em] text-left lg:text-justify"
              >
              ...
              <motion.p
                variants={lineVariants}
               className="text-gray-400 mt-5 md:mt-6 text-xs md:text-sm leading-6 md:leading-relaxed tracking-[0.01em] text-left lg:text-justify"
              >
