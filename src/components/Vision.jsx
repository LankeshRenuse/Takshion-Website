    ...
    <section id="vision" className="py-12  px-4 scroll-mt-[30px]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
          <motion.div 
  className="bg-black/1 backdrop-blur-lg border border-[rgba(92,252,0,0.67)]/20 rounded-2xl p-8 shadow-xl glow-target text-left text-balance"
          ...
          >
            ...
            <motion.ul className="space-y-4 text-gray-300 leading-7 text-left text-balance">
              <motion.li variants={lineVariants} className="flex gap-3 items-start">
               ...
               <span className="flex-1 min-w-0 leading-7 text-balance">
